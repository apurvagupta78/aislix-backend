...
SUB_CATEGORY_BRAND_HINTS: dict[str, dict[str, set[str]]] = {
    "personal care": {
        ...
        "mouthwash": {"colgate", "listerine", "oral-b", "oral b", "closeup", "sensodyne"},
...
SUB_CATEGORY_PRODUCT_KEYWORDS: dict[str, list[str]] = {
    ...
    "toothpaste": ["toothpaste", "toothbrush", "tooth brush", "dental"],
    "mouthwash": ["mouthwash", "mouth wash", "oral rinse", "plax", "listerine", "colgate plax"],
